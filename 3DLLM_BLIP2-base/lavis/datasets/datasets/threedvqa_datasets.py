...
class ThreeDVQADataset(VQADataset, __DisplMixin):
    def __init__(self, vis_processor, text_processor, vis_root, ann_paths):
        ...
        self.pc_feat_root = "/scratch/bbsg/yunzem2/dataset/3DLLM/finetuning_scannet/voxelized_features_sam_nonzero_preprocess"  
        self.voxel_root = "/scratch/bbsg/yunzem2/dataset/3DLLM/finetuning_scannet/voxelized_voxels_sam_nonzero_preprocess"  
        self.annotation = [
