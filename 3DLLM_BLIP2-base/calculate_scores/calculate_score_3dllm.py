...
if __name__=="__main__":
    ...
    parser.add_argument("--test_file", type=str, help="Test file", default="data_part2_scene_v3_test.json")
    ...
    golds = json.load(open(os.path.join('/scratch/bbsg/yunzem2/dataset/3DLLM/pretraining', args.test_file)))
