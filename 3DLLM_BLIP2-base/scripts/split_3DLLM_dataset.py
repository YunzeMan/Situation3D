...
# Usage
input_file_v2 = '/scratch/bbsg/yunzem2/dataset/3DLLM/pretraining/data_part2_scene_v2.json'
input_file_v3 = '/scratch/bbsg/yunzem2/dataset/3DLLM/pretraining/data_part2_scene_v3.json'
input_file_v3_01 = '/scratch/bbsg/yunzem2/dataset/3DLLM/pretraining/chat_val_v3.json'
input_file_v3_02 = '/scratch/bbsg/yunzem2/dataset/3DLLM/pretraining/task_val_v3.json'

mapping_file_v2 = '/scratch/bbsg/yunzem2/dataset/3DLLM/pretraining/final_scene_map_dict_scan_v2.json'
mapping_file_v3 = '/scratch/bbsg/yunzem2/dataset/3DLLM/pretraining/final_scene_map_dict_scan_v3.json'
...
# train_file = '/scratch/bbsg/yunzem2/dataset/3DLLM/pretraining/data_part2_scene_v2_3_train.json'
# test_file = '/scratch/bbsg/yunzem2/dataset/3DLLM/pretraining/data_part2_scene_v2_3_test.json'
train_file = '/scratch/bbsg/yunzem2/dataset/3DLLM/pretraining/data_part2_scene_v3_train.json'
test_file = '/scratch/bbsg/yunzem2/dataset/3DLLM/pretraining/data_part2_scene_v3_test.json'
